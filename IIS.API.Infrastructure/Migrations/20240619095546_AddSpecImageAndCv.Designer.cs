...
namespace IIS.API.Infrastructure.Migrations
{
    ...
    [Migration("20240619095546_AddSpecImageAndCv")]
    partial class AddSpecImageAndCv
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Application", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 19, 9, 55, 45, 968, DateTimeKind.Utc).AddTicks(8159));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Author = "Author 1",
                            Date = new DateTime(2024, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(8752),
                        ...
                        new
                        {
                            ...
                            Author = "Author 2",
                            Date = new DateTime(2024, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(8758),
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Case", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 1400m,
                            Description = "Description 1",
                            EndDate = new DateTime(2024, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7160),
                            ImagesUri = "[]",
                            Name = "Name 1",
                            StartDate = new DateTime(2024, 1, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7156)
                        },
                        new
                        {
                            ...
                            Cost = 3500m,
                            Description = "Description 2",
                            EndDate = new DateTime(2024, 4, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7163),
                            ImagesUri = "[]",
                            Name = "Name 2",
                            StartDate = new DateTime(2023, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7162)
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7165),
                            ImagesUri = "[]",
                            Name = "Name 3",
                            StartDate = new DateTime(2024, 5, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(7165)
                        });
                });
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c43a31be-bfd7-4753-b9e7-9a4194c9ff50"),
                            Complexity = 5,
                            Cost = 159m,
                            Description = "description 1",
                            Name = "service 1"
                        ...
                        new
                        {
                            Id = new Guid("49ba3784-8ec8-426b-96b4-1f94bfdd5931"),
                            Complexity = 3,
                            Cost = 109m,
                            Description = "description 2",
                            Name = "service 2"
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "City 1",
                            Country = "Country 1",
                            DateOfBirth = new DateTime(2004, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(5441),
                            Email = "email1@gmail.com",
                            Gender = 1,
                            Name = "Name 1",
                            NormalizedEmail = "email1@gmail.com",
                        ...
                        new
                        {
                            ...
                            City = "City 2",
                            Country = "Country 2",
                            DateOfBirth = new DateTime(1974, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(5458),
                            Email = "email2@gmail.com",
                            Gender = 2,
                            Name = "Name 2",
                            NormalizedEmail = "email2@gmail.com",
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Specialist", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "City 3",
                            Country = "Country 3",
                            DateOfBirth = new DateTime(2004, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(8941),
                        ...
                        new
                        {
                            ...
                            City = "City 4",
                            Country = "Country 4",
                            DateOfBirth = new DateTime(1974, 6, 19, 12, 55, 45, 968, DateTimeKind.Local).AddTicks(8945),
