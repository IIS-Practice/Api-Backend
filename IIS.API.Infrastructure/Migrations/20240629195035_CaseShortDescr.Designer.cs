            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Faq", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("68ef8340-f170-46de-ac5f-5a7f59f2103e"),
                            Answer = "Answer 1",
                            Question = "Question 1"
                        },
                        new
                        {
                            Id = new Guid("68ef8259-f170-46de-ac5f-5a7f59f2103e"),
                            Answer = "Answer 2",
                            Question = "Question 2"
                        },
                        new
                        {
                            Id = new Guid("68ef8340-f170-79de-ac5f-5a7f53f2103e"),
                            Answer = "Answer 3",
                            Question = "Question 3"
                        });
                });
            ...
            modelBuilder.Entity("IIS.API.Domain.Entities.Specialist", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Аттава",
                            Country = "Канада",
                            DateOfBirth = new DateTime(1964, 9, 2, 23, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Брауард",
                            Country = "США",
                            DateOfBirth = new DateTime(1998, 1, 23, 22, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Тобольск",
                            Country = "Россия",
                            DateOfBirth = new DateTime(2000, 5, 11, 23, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Лейпциг",
                            Country = "ГДР",
                            DateOfBirth = new DateTime(1989, 9, 1, 23, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Сан-Фернандо",
                            Country = "США",
                            DateOfBirth = new DateTime(2003, 11, 1, 22, 20, 25, 988, DateTimeKind.Local),
                            Email = "eli@gmail.com",
                            Gender = 1,
                            Name = "Илай",
                        ...
                        new
                        {
                            ...
                            City = "Мистик-Фоллс",
                            Country = "США",
                            DateOfBirth = new DateTime(1993, 10, 31, 22, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Пикалево",
                            Country = "Россия",
                            DateOfBirth = new DateTime(1973, 9, 7, 23, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Краснодар",
                            Country = "Россия",
                            DateOfBirth = new DateTime(1995, 7, 25, 23, 20, 25, 988, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            City = "Ленинград",
                            Country = "Россия",
                            DateOfBirth = new DateTime(1991, 11, 5, 22, 20, 25, 988, DateTimeKind.Local),
